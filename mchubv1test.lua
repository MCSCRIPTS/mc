local MCSCRIPTS = loadstring(game:HttpGet("https://raw.githubusercontent.com/MCSCRIPTS/mc/refs/heads/main/MC'S%20script%20hub%20v1.lua"))()
local Window = MCSCRIPTS:MakeWindow({
  Title = "MC : Blox Fruits",
  SubTitle = "by MC",
  SaveFolder = "MC | Blox Fruits.lua"
})
...
Discord:AddDiscordInvite({
  Name = "MC | Community",
  Description = "Join our discord PLS ",
  Logo = "rbxassetid://15298567397",
  Invite = "https://discord.gg/6UznaR7mPz"
})
